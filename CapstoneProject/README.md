...
4. Clone or download the notebooks and scripts from this repo: 'hyperparameter_tuning.ipynb', 'automl.ipynb', 'train.py' and 'score.py', and upload them to your working folder in the Studio
...
### Project Overview
We will train and optimize an Azure ML pipeline using two different methods: **Hyperparameter Tuning** and **Auto ML**. For the training model, a simple ligistic regression model was chosen, the best one from both approaches is then deployed as a 
